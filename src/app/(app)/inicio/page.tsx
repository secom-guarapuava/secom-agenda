  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-2.5 mt-4">
        <MetricCard label="Agendas hoje" valor={db.agendas.length} icon="M3 9h18M8 2v4M16 2v4M4 5h16a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1z" />
      ...
      {proxima && (
        <Link href="/agendas" className="relative block bg-navy-grad text-white rounded-2xl p-4 mt-3 shadow-navy glow-top overflow-hidden active:scale-[0.99] transition">
          <div className="relative">
            ...
            <div className="text-[12px] text-slate-200 mt-1.5 flex items-center gap-3">
